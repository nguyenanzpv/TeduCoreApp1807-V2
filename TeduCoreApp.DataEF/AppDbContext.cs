...
using TeduCoreApp.DataEF.Configurations;
using TeduCoreApp.DataEF.Extensions;

namespace TeduCoreApp.DataEF
{
    //cai microsoft.aspnetcore.identity
    public class AppDbContext: IdentityDbContext<AppUser, AppRole, Guid>
    {
        ...
        //khai bao EF moi nhan duoc cac bange. Su dung ten nay de truy cap cac bang
        ...
        {
            //class ke thue tu IDateTracking -> se tu add them datecreated va2 datemodified
            //lay ra cac item bi modified
